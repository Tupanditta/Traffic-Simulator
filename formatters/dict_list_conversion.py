...
def dict_list_str_conversion(dict_list: list) -> list:
  ...
  day_type_str_options = {0: "monday", 1: "tuesday", 2: "wednesday", 3: "thursday", 4: "friday", 5: "saturday", 6: "sunday"}
  ...
  for dictionary in dict_list:
    ...
    dictionary["date"]["day_type"] = day_type_str_options[dictionary["date"]["day_type"]]
