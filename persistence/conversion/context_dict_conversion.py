...
def context_dict_str_conversion(context_dict):
  ...
  posible_states_transition_matrix = context_dict["transition_matrix"]["posible_states"]
  posible_states_environmental_multipliers = context_dict["environmental_multipliers"]["posible_states"]
  posible_states_initial_weather = context_dict["initial_weather"]["posible_states"]
